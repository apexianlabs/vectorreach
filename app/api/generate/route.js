...
export async function POST(request) {
  try {
    ...
    const { sender_name, sender_role, prospect_name, prospect_company, prospect_role, linkedin_info, offering, goal, tone, userId } = body
